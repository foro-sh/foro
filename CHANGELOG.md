...
* Merge branch 'main' into claude/issue-79 ([b6bf3cd](https://github.com/foro-sh/foro/commit/b6bf3cd))
* Merge branch 'main' into claude/issue-80 ([f6a0fd8](https://github.com/foro-sh/foro/commit/f6a0fd8))
* Merge branch 'main' into claude/issue-81 ([5c4448f](https://github.com/foro-sh/foro/commit/5c4448f))
* Merge branch 'main' into dependabot/npm_and_yarn/packages/typescript/npm-f07d571036 ([4bb7728](https://github.com/foro-sh/foro/commit/4bb7728))
* Merge branch 'main' into dependabot/uv/packages/python/uv-31eaf12883 ([8e12a2c](https://github.com/foro-sh/foro/commit/8e12a2c))
* Merge branch 'main' into dependabot/uv/packages/python/uv-31eaf12883 ([1de2ad6](https://github.com/foro-sh/foro/commit/1de2ad6))
* Merge branch 'main' into fix/docs-mcp-url ([52c8a0d](https://github.com/foro-sh/foro/commit/52c8a0d))
* Merge pull request #73 from foro-sh/dependabot/npm_and_yarn/packages/typescript/npm-f07d571036 ([a48bf7f](https://github.com/foro-sh/foro/commit/a48bf7f)), closes [#73](https://github.com/foro-sh/foro/issues/73)
* Merge pull request #82 from foro-sh/claude/issue-78 ([0590899](https://github.com/foro-sh/foro/commit/0590899)), closes [#82](https://github.com/foro-sh/foro/issues/82)
* Merge pull request #83 from foro-sh/claude/issue-79 ([c927e84](https://github.com/foro-sh/foro/commit/c927e84)), closes [#83](https://github.com/foro-sh/foro/issues/83)
* Merge pull request #84 from foro-sh/claude/issue-80 ([9926c7f](https://github.com/foro-sh/foro/commit/9926c7f)), closes [#84](https://github.com/foro-sh/foro/issues/84)
* Merge pull request #85 from foro-sh/claude/issue-81 ([329e683](https://github.com/foro-sh/foro/commit/329e683)), closes [#85](https://github.com/foro-sh/foro/issues/85)
* Merge pull request #86 from foro-sh/fix/docs-mcp-url ([6381a55](https://github.com/foro-sh/foro/commit/6381a55)), closes [#86](https://github.com/foro-sh/foro/issues/86)
* Merge pull request #87 from foro-sh/dependabot/github_actions/astral-sh/setup-uv-10.0.1 ([f8e5f7b](https://github.com/foro-sh/foro/commit/f8e5f7b)), closes [#87](https://github.com/foro-sh/foro/issues/87)
* Merge pull request #88 from foro-sh/dependabot/uv/packages/python/uv-31eaf12883 ([faa807d](https://github.com/foro-sh/foro/commit/faa807d)), closes [#88](https://github.com/foro-sh/foro/issues/88)
* Merge pull request #90 from foro-sh/docs/readme-rewrite ([150b951](https://github.com/foro-sh/foro/commit/150b951)), closes [#90](https://github.com/foro-sh/foro/issues/90)
* Merge pull request #91 from foro-sh/ci/blacksmith-runners ([f5be6e5](https://github.com/foro-sh/foro/commit/f5be6e5)), closes [#91](https://github.com/foro-sh/foro/issues/91)
* Merge pull request #92 from foro-sh/fix/mcp-upper-bound ([2a5662a](https://github.com/foro-sh/foro/commit/2a5662a)), closes [#92](https://github.com/foro-sh/foro/issues/92)
* Merge pull request #96 from foro-sh/claude/issue-95 ([f995452](https://github.com/foro-sh/foro/commit/f995452)), closes [#96](https://github.com/foro-sh/foro/issues/96)
* Merge pull request #97 from foro-sh/fix/release-preset-pin ([0403b42](https://github.com/foro-sh/foro/commit/0403b42)), closes [#97](https://github.com/foro-sh/foro/issues/97)
* fix(ci): keep UV_PYTHON off the pytest step ([d92bd48](https://github.com/foro-sh/foro/commit/d92bd48))
* fix(ci): pin the conventionalcommits preset semantic-release renders with ([63fc3a6](https://github.com/foro-sh/foro/commit/63fc3a6)), closes [#91](https://github.com/foro-sh/foro/issues/91)
* fix(plugins): point foro-docs MCP at docs.foro.sh ([0191877](https://github.com/foro-sh/foro/commit/0191877))
* fix(python): restore the mcp <2.0 bound and require fastmcp 3 ([45b06eb](https://github.com/foro-sh/foro/commit/45b06eb)), closes [#88](https://github.com/foro-sh/foro/issues/88)
* fix(typescript): declare node types explicitly for TypeScript 7 ([9e73e13](https://github.com/foro-sh/foro/commit/9e73e13))
* test(python): cover auth logout deleting credentials when revoke fails ([d8f421e](https://github.com/foro-sh/foro/commit/d8f421e))
* test(python): cover auth status/logout/token with no stored login ([7862262](https://github.com/foro-sh/foro/commit/7862262))
* test(python): cover auth token prints exactly the stored token ([6252901](https://github.com/foro-sh/foro/commit/6252901))
* test(python): cover dev CLI killing a server that ignores terminate ([71394c2](https://github.com/foro-sh/foro/commit/71394c2))
* test(python): cover dev CLI listing no tools as none ([ba12b5b](https://github.com/foro-sh/foro/commit/ba12b5b))
* test(python): cover dev CLI reporting DevError without a traceback ([f8a2dbf](https://github.com/foro-sh/foro/commit/f8a2dbf))
* test(python): cover dev CLI reporting the ManifestError reason ([3c1e1f1](https://github.com/foro-sh/foro/commit/3c1e1f1))
* test(python): cover dev CLI terminating the server on Ctrl+C ([ec6bcbb](https://github.com/foro-sh/foro/commit/ec6bcbb))
* test(python): cover egress absent-vs-empty and entry validation ([1132126](https://github.com/foro-sh/foro/commit/1132126))
* test(python): cover egress in the shared manifest case table ([6a201d8](https://github.com/foro-sh/foro/commit/6a201d8))
* test(python): cover insecure config permissions warning on auth status ([bbe6265](https://github.com/foro-sh/foro/commit/bbe6265))
* test(python): cover node dependency-manager bun rejection ([1da8827](https://github.com/foro-sh/foro/commit/1da8827))
* test(python): cover node dependency-manager lockfile detection ([1f14b2a](https://github.com/foro-sh/foro/commit/1f14b2a))
* test(python): cover node dependency-manager override short-circuit ([f4736ca](https://github.com/foro-sh/foro/commit/f4736ca))
* test(python): mirror the platform's full egress case list ([4cd11e2](https://github.com/foro-sh/foro/commit/4cd11e2))
* test(python): rename test_a_non_numeric_mcp_port_names_the_variable ([bb25bc6](https://github.com/foro-sh/foro/commit/bb25bc6))
* test(python): rename test_run_defaults_to_port_8000_without_mcp_port ([3bfd5ec](https://github.com/foro-sh/foro/commit/3bfd5ec))
* test(python): rename test_run_reads_port_from_mcp_port_env ([e949e06](https://github.com/foro-sh/foro/commit/e949e06))
* test(python): tighten logged_in fixture perms and add logged_out fixture ([8cbb9f5](https://github.com/foro-sh/foro/commit/8cbb9f5))
* docs: rewrite README as a dev tool overview ([dcf05c2](https://github.com/foro-sh/foro/commit/dcf05c2))
* docs(python): document the egress field ([c58385e](https://github.com/foro-sh/foro/commit/c58385e))
* feat(python): validate the manifest egress allowlist ([9717cd1](https://github.com/foro-sh/foro/commit/9717cd1)), closes [907/#908](https://github.com/foro-sh/foro/issues/908)
* feat(typescript): add invalid_egress to the rejection union ([d2ac6bf](https://github.com/foro-sh/foro/commit/d2ac6bf)), closes [foro-sh/platform#908](https://github.com/foro-sh/platform/issues/908)
* ci: run workflows on Blacksmith runners ([2101c0e](https://github.com/foro-sh/foro/commit/2101c0e))
* chore(deps-dev): bump the npm group across 1 directory with 2 updates ([1e3a271](https://github.com/foro-sh/foro/commit/1e3a271))
* chore(deps): bump astral-sh/setup-uv from 9.0.0 to 10.0.1 ([6c34f24](https://github.com/foro-sh/foro/commit/6c34f24))
* chore(deps): bump the uv group across 1 directory with 4 updates ([587dab7](https://github.com/foro-sh/foro/commit/587dab7))

## [0.11.0](https://github.com/foro-sh/foro/compare/v0.10.1...v0.11.0) (2026-08-14)

## [0.10.1](https://github.com/foro-sh/foro/compare/v0.10.0...v0.10.1) (2026-08-13)
